...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       Posts::create([
           ...
           'slug' =>
        SlugService::createSlug(Posts::class, 'slug', $request->title),
    ...
    {
        //
       return view('blog.show')->with('posts', Posts::where('slug', $slug)->first());
    ...
    public function update(Request $request, $slug)
    {
        ...
        return redirect('/blog')->with('message', 'your post has updated');
    }
